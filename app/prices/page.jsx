...
export default function Page() {
  ...
  return (
    <motion.div initial={{ opactity: 0 }} whileInView={{ opactity: 1 }} transition={{ delay: 200 }} className=" h-screen flex flex-col items-center justify-center gap-5 box-border xl:my-96">
